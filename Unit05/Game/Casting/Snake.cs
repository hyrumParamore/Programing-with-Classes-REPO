...
namespace Unit05.Game.Casting
{
    ...
    public class Snake : Actor
    {
        ...
        /// </summary>
        public Snake(Point pointset, Point setvelocity)
        {
            PrepareBody(pointset, setvelocity);
        ...
        private void PrepareBody(Point pointset, Point setvelocity)
        {

            // int 
            // int velocity = setvelocity;
            int xvelocity = setvelocity.GetX();
            // int yvelocity = setvelocity.GetY();
